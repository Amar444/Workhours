...
class WorkhoursControllerTest < ActionController::TestCase
  ...
  test "should create workhour" do
    assert_difference('Workhour.count') do
      post :create, workhour: { day: @workhour.day, factor: @workhour.factor, hours: @workhour.hours, month: @workhour.month, nettoLoon: @workhour.nettoLoon, user_id: @workhour.user_id, year: @workhour.year }
    end
  ...
  test "should update workhour" do
    put :update, id: @workhour, workhour: { day: @workhour.day, factor: @workhour.factor, hours: @workhour.hours, month: @workhour.month, nettoLoon: @workhour.nettoLoon, user_id: @workhour.user_id, year: @workhour.year }
    assert_redirected_to workhour_path(assigns(:workhour))
  end
